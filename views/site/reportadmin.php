...
<div class="col-md-12" >
    ...
    <div class="col-md-6" style="font-size: 1.5em;">
        department-<?php echo $rown[0]['dep_name']?>
    </div>
    <div class="col-md-6" style="font-size: 1.5em;">
        HOD-<?php echo $rown[0]['dep_hod']?>
    </div><br>
    <br>
...
<?php 
    ...
    <div class="box_yr"id="<?php echo $rowy['year'] ?>" >
        ...
        <p style="font-weight:bold; color: #333">
            Total Amount <span style="color:red">&#8377 <?php 
            if(empty($rowocr)){echo '';}
                            else{
                            echo   $rowocr[0]['opening_ammount']; }
            ?> </span>
            &nbsp; (Total Expenditure <span style="color:red">&#8377 <?php if(empty($rowocr)){echo '';}
                            else{
                            echo   $rowocr[0]['total_expend']; }?> </span>       
            and Available Balance <span style="color:red">&#8377 <?php if(empty($rowocr)){echo '';}
                            else{
   ...
   <?php         $rowbh =(new \yii\db\Query())
    ...
    <?php        foreach($rowbh as $yr=>$rowb){?>
        <div class="tbl" id="<?php echo $rowy['year'].$rowb['budget_head']; ?>">
            <div class="headings" style=" border-radius: 0px;font-size:1.3em ; background-color: #e6c884; color:#421c52"> <?php echo$rowb['budget_head']; ?></div> 
    ...
    <tbody>
     ...
     <td><?php if(empty($rowbhs)){echo '';}
                            else{
                            echo  $rowbhs[0]['bh_total_amount'];}?> </td>
            <td><?php if(empty($rowbhs)){echo '';}
                            else{
                            echo   $rowbhs[0]['bh_expend'];}?> </td>
            <td><?php if(empty($rowbhs)){echo '';}
                            else{
                            echo   $rowbhs[0]['bh_balance'];}?> </td>   
         </tr>
