 ...
 ?>
    ...
    <div class="col-md-9">
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div  class="col-md-3 txthead" >Bill No.<br> 
                <span class="rdbox" id="expenditure-dep_id" >
                    <?php echo $model->bill_no; ?>
                </span>
            </div>
            
            <div  class="col-md-3 txthead" >Bill Diary No.<br> 
                <span class="rdbox" id="expenditure-dep_id" >
                    <?php echo $model->bill_diary_no; ?>
                </span>
            </div>
            
            <div  class="col-md-3 txthead" >Bill Date<br> 
                <span class="rdbox" id="expenditure-dep_id" >
                    <?php echo $model->bill_date; ?>
                </span>
            </div>
